...
if __name__=='__main__':
    ...
    exprs=[['2 3 +',dict()],['2 3 + 4 5 * -',dict()],['7 4 * 2 + 3 *',dict()],['2 3 4 *',dict()]]
    assignments={'A':10,'B':20, 'C':3}
    exprsl=[['A B +',assignments],['A B + C *',assignments],['A A * B B * C C * + +',assignments]]
    for [expr,assignment]in exprsl+exprs:
        try: 
            val=postEval(expr,assignment)
