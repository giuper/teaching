...
class Stack:
    ...
    # Se lo stack e' vuoto lancia un'eccezione
    ...
    # Restituisce true se lo stack non e' vuoto, false altrimenti
    def __bool__(self):
    ...
    # x in self 
    # per un oggetto self delle classe Stack
    # Restituisce true se item e' contenuto nello stack, false altrimenti
    ...
    # Usata da python per valutare l'espressione Booleana
    # self!=other
    # Restituisce true se lo stack other e' diverso dallo stack self
