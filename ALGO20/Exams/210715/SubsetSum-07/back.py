...
#lmove -- last move performed
    ...
    def Solve(self,verbose=False):
        statIn=self.initState()
        self.s.push([statIn,None]) # no move has been taken
        self.setVisited(statIn)    # responsability of the lower class
        
        while self.s:
            [state,move]=self.s.pop()
            nmove=self.nextAdmMove(state,move)
