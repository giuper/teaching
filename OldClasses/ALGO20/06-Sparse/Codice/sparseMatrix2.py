...
# Restituisce il valore dell'elemento (i, j), x[i, j]
    ...
    def __mul__(self, B):
        ...
        C=SparseMatrix(self.numRows(), B.numCols())

        for elementoS in self._elementList:
            for elementoB in B._elementList:
               if elementoS._col==elementoB._row:
                    C[elementoS._row,elementoB._col]=C[elementoS._row,elementoB._col]+elementoS._value*elementoB._value
